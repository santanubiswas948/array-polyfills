...
## Prerequisites
The `index.js` which is inside `main` branch of `https://github.com/santanubiswas948/array-polyfills` repository. People have to add this file before of any others js files or js codes of your application.
